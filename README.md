...
| 3   | [Longest Substring Without Repeating Characters - using Set](string/sliding_window/LongestSubstringWithoutRepeatingCharacters.java), Solution 2, Solution 3 - Sliding window but not using my template, Solution 4, Solution 5, Solution 6 | Medium | String, Map, Two Pointers, DP, Set | |
