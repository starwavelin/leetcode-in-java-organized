...
| 271 | Encode and Decode Strings $ | Medium | Design, String | |
...
| 121 | Best Time to Buy and Sell Stock, Solution 2 - Sliding Window | Easy | Sliding Window, Enum | |
| 120 | Triangle | Medium | | |
...
| 3   | Longest Substring Without Repeating Characters, 
    ...
    Solution 3 - Sliding window but not using my template, Solution 4, Solution 5, Solution 6 | Medium | String, Map, Two Pointers, DP, Set | |
